    ...
    <div className="flex flex-col gap-[40px]">
      {favoriteProducts.length > 0 ? (
        favoriteProducts.map((product) => {
          return (
            <div key={product.id} className="w-full flex h-[200px]">
              <div>
                <Link to={`/${product.id}`}>
                  <img
              ...
              <div className="w-[840px] bg-white px-[40px] py-[20px] flex flex-col justify-between">
                ...
                <div className="flex flex-col gap-[20px]">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-[10px]">
                      ...
                      <div className="flex items-center gap-[7px]">
                        <img src={Divan2} alt="" />
                        <p className="text-[#999999]">100 m²</p>
                      </div>
                      <div className="flex items-center gap-[7px]">
                        <img src={Divan3} alt="" />
                        <p className="text-[#999999]">Евроремонт</p>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-between items-center">
                    <p className="text-black">
                      г.Ташкент, Чиланзарский р-н, ул.Улица
                    </p>
              ...
              <div className="bg-[#fca311] rounded-r-xl w-[10px]"></div>
            </div>
          );
        })
      ) : (
...
export default FavoriteFirstBody;
